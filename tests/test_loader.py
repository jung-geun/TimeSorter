...
def test_columns_present():
    mock_ds = _make_ds()
    with patch("timesorter.data.loader.load_dataset", return_value=mock_ds):
        from timesorter.data.loader import load_dpo_dataset
...
def test_missing_column_raises():
    ...
    with patch("timesorter.data.loader.load_dataset", return_value=bad_ds):
        from timesorter.data.loader import load_dpo_dataset
